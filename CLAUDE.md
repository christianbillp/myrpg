...
- "Update documentation" means updating `ui.md`, `requirements.md`, and `data_structure.md`.
- Before creating a commit, ensure `ui.md`, `requirements.md`, and `data_structure.md` are up to date with any changes made.
