...
type Feature = "campsites" | "coastline" | "path" | "intersection" | "3-room" | "5-room" | "stairs" | "clearing" | "river";

const OUTSIDE_TERRAINS: Terrain[] = ["grassland", "forest", "urban"];
const INSIDE_TERRAINS:  Terrain[] = ["dungeon", "cave"];
const OUTSIDE_FEATURES: Feature[] = ["campsites", "coastline", "path", "intersection", "clearing", "river"];
