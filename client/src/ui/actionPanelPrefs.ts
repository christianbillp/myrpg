...
export const ACTION_BUTTON_CATALOG: ReadonlyArray<ActionButtonCatalogEntry> = [
  ...
  { id: 'offhand', label: 'Off-Hand Attack', glyph: '⚔', description: 'Two-Weapon Fighting: a bonus-action strike with the off-hand Light weapon (free with a Nick weapon).' },
...
const LABEL_TO_ID: Readonly<Record<string, string>> = {
  ...
  'SHORT REST': 'short-rest', 'KNOCK OUT': 'knock-out', DETACH: 'detach', ESCAPE: 'escape', LIGHT: 'toggle-light', DOUSE: 'toggle-light', 'OFF-HAND': 'offhand', ATTUNE: 'attune',
