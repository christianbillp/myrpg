...
import * as authoringApi from './AuthoringApi';
import * as assetApi from './AssetApi';
import { API_URL, WS_URL } from './apiBase';
...
export class GameClient {
  // Stateless REST surface — delegated to the split API modules so call
  // sites keep the single-client ergonomics.
  createCharacter = characterApi.createCharacter;
  suggestCharacter = characterApi.suggestCharacter;
  generateCharacterIdentity = characterApi.generateCharacterIdentity;
  fetchCharacters = characterApi.fetchCharacters;
  deleteCharacter = characterApi.deleteCharacter;
  loadSave = characterApi.loadSave;
  deleteSave = characterApi.deleteSave;
  loadAdventureSave = characterApi.loadAdventureSave;
  deleteAdventureSave = characterApi.deleteAdventureSave;
  generateEncounter = authoringApi.generateEncounter;
  refineEncounter = authoringApi.refineEncounter;
  ...
  listAdventures = authoringApi.listAdventures;
  saveAdventure = authoringApi.saveAdventure;
  listNpcs = authoringApi.listNpcs;
  saveNpc = authoringApi.saveNpc;
  testNpcChat = authoringApi.testNpcChat;
  updateEncounter = authoringApi.updateEncounter;
  listMaps = authoringApi.listMaps;
  listFactions = authoringApi.listFactions;
  deleteAllGeneratedMaps = authoringApi.deleteAllGeneratedMaps;
  promoteEncounter = authoringApi.promoteEncounter;
  generateMap = authoringApi.generateMap;
  listTokenParts = assetApi.listTokenParts;
  listTokens = assetApi.listTokens;
  listTokenSpecs = assetApi.listTokenSpecs;
  loadTokenSpec = assetApi.loadTokenSpec;
  saveToken = assetApi.saveToken;
  listTileLegends = assetApi.listTileLegends;
  listTilesetMeta = assetApi.listTilesetMeta;
  saveTileEntry = assetApi.saveTileEntry;
  generateTile = assetApi.generateTile;
  listGeneratedTiles = assetApi.listGeneratedTiles;
  saveGeneratedTile = assetApi.saveGeneratedTile;
