...
- **US-066** As a developer, I want class features to be authored as data + handler so that adding new class abilities scales to all 12 SRD classes without touching the Player Panel.
