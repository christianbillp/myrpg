...
import { doAttack as caDoAttack, doDash as caDoDash, doDodge as caDoDodge, doDisengage as caDoDisengage, doDetach as caDoDetach, doEscapeGrapple as caDoEscapeGrapple, doHide as caDoHide, throwItem as caThrowItem, doResolveReroll as caDoResolveReroll, doGrapple as caDoGrapple, doShove as caDoShove, doHelp as caDoHelp, doReady as caDoReady } from '../CombatActions.js';
...
import { doStudy, doMagicRite } from '../StudySystem.js';
...
export const PLAYER_ACTIONS: Registry = {
  ...
  study:                (ctx, a, events) => doStudy(ctx, a.tileX, a.tileY, events),
  magic:                (ctx, a, events) => doMagicRite(ctx, a.tileX, a.tileY, events),
